...
RUN apt update && \
  apt install --no-install-recommends -y make gcc g++ libc6-dev cmake git gawk bison flex rsync valac python3-minimal python3-pkg-resources python3-distutils && \
