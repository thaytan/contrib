...
2. Clone the project: `https://gitlab.com/aivero/public/librealsense-rs` and `cd librealsense-rs`
...
7. Open a merge request
    1. Navigate to https://gitlab.com/aivero/public/librealsense-rs in a browser
