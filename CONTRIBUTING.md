...
2. Clone the project: `https://gitlab.com/aivero/public/gstreamer/gst-depth-meta-rs.git` and `cd gst-depth-meta-rs`
...
7. Open a merge request
    1. Navigate to https://gitlab.com/aivero/public/gstreamer/gst-depth-meta-rs in a browser
