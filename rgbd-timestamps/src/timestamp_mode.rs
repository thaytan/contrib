    ...
    fn get_glib_type() -> glib::Type {
        ...
        ONCE.call_once(|| {
            ...
            gobject_sys::GEnumValue {
                ...
                gobject_sys::GEnumValue {
                    value: TimestampMode::FrameCounting as i32,
                    value_name: "FrameCounting: Generate timestamps by counting frames and the negotiated framerate. Apply timestamps to buffers of all streams. A common timestamp is applied to all buffers that belong to a single frameset.\0" as *const _ as *const _,
                    value_nick: "frame_counting\0" as *const _ as *const _,
                },
                gobject_sys::GEnumValue {
                    value: 0,
                    value_name: ptr::null(),
...
impl glib::translate::FromGlib<i32> for TimestampMode {
    fn from_glib(val: i32) -> Self {
        match val {
            ...
            5 => TimestampMode::FrameCounting,
            _ => unreachable!("Invalid GstTimestampMode, supported variants are 0 (Ignore), 1 (ClockMain, 2 (ClockAll), 3 (CameraCommon), 4 (CameraIndividual) and 5 (FrameCounting)"),
        }
    }
}
