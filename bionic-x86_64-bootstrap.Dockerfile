...
RUN apt update && \
  apt install --no-install-recommends -y make gcc-7 g++-7 build-essential cmake git git-lfs ca-certificates python3-minimal python3-pkg-resources python3-distutils && \
