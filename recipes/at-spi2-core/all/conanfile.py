...
class AtSpi2CoreConan(ConanFile):
    ...
    def source(self):
        tools.get(
            "https://gitlab.gnome.org/GNOME/at-spi2-core/-/archive/AT_SPI2_CORE_{0}/at-spi2-core-AT_SPI2_CORE_{0}.tar.gz".format(
    ...
    def build(self):
        ...
        meson = Meson(self)
        meson.configure(
            source_folder="at-spi2-core-AT_SPI2_CORE_" + self.version.replace(".", "_"),
            args=args,
